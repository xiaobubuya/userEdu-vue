  ...
  <div class="main">
    ...
    <div class="sign-up-container">
      <el-form ref="userForm" :model="params">
        ...
        <el-form-item :rules="[{ required: true, message: '请输入邮箱', trigger: 'blur' },{validator: checkEmail, trigger: 'blur'}]" class="input-prepend restyle no-radius" prop="email">
          <div>
        ...
        <el-form-item :rules="[{ required: true, message: '请输入验证码', trigger: 'blur' }]" class="input-prepend restyle no-radius" prop="code">
          ...
          <div class="btn" style="position:absolute;right: 0;top: 6px;width: 40%;">
            <!--<a :value="codeTest" href="javascript:" type="button" style="border: none;background-color: rgba(255,255,255,0.6)" @click="getCodeFun()">{{ codeTest }}</a>-->
            <a :value="codeTest" href="javascript:" type="button" style="border: none;background-color: rgba(255,255,255,0.6)" @click="getCodeFunEmail()">{{ codeTest }}</a>
          </div>
        </el-form-item>
