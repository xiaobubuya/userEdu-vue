  ...
  <div class="main">
    ...
    <div class="sign-up-container">
      <el-form ref="userForm" :model="user">
        ...
        <el-form-item :rules="[{ required: true, message: '请输入邮箱', trigger: 'blur' },{validator: checkEmail, trigger: 'blur'}]" class="input-prepend restyle" prop="email">
          <div >
            <el-input v-model="user.email" type="text" placeholder="邮箱"/>
            <i class="iconfont icon-phone" />
          </div>
        </el-form-item>
